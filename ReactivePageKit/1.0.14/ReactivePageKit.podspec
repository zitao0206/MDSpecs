#
# Be sure to run `pod lib lint ReactivePageKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'ReactivePageKit'
  def self.smart_version
    tag = `git describe --abbrev=0 --tags 2>/dev/null`.strip
    if $?.success? then tag else "0.0.1" end
  end
  s.version          = "1.0.14"
  s.summary          = 'A short description of ReactivePageKit.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'ReactivePageKit/Classes/**/*'
  
  # s.resource_bundles = {
  #   'ReactivePageKit' => ['ReactivePageKit/Assets/*.png']
  # }
